    ...
    return (
        <header className="flex items-center justify-between mb-8 ">
            ...
            <nav className="space-x-1">
                <button 
                    className="btn text-pink-500 text-2xl hover:text-pink-700"
                    onClick={handleViewLiked}
                >
                    ♥
                </button>
                <button 
                    className="btn text-purple-500 text-2xl hover:text-purple-700"
                    onClick={handleViewSaved}
                >
                    ★
                </button>
                <button 
                    className="btn text-white text-xl hover:text-gray-300"
                ...
                <button 
                    className='btn text-[#00FA9A] text-xl hover:text-[#32CD32]'
